...
const DORA_COLORS = ['#f59e0b', '#ef4444', '#fbbf24', '#84cc16', '#22c55e', '#ea580c'];
const JARVIS_COLORS = ['#3b82f6', '#0ea5e9', '#8b5cf6', '#06b6d4', '#10b981', '#1d4ed8'];
...
export function PixelCanvas({ palette }: { palette: string[] }) {
  ...
  return <canvas ref={canvasRef} width={32} height={32} className="h-full w-full object-cover" />;
}
